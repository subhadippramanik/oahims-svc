...
<jsp:useBean id="ipdregistration" class="com.oa.kh.ipd.IpdRegistration"/>
...
if(request.getParameter("formAction")!=null){
    ...
    /* For perform Actions based on Request */
	  ...
	  {
		int mCnt = opdregistration.checkOpdRegistrationId(regnno);
		if(mCnt==0){
			...
			%><center><h2>Code : <%=regnno%> already exists. Please try with another.</h2></center><%
		}
     }
        	...
        	<table border="0" cellpadding="0" cellspacing="0">
            	<tr>
                	<td style="BORDER-BOTTOM: #c3d5ff 0PX SOLID;WIDTH:120px;HEIGHT:33px" 
                    		background="../images/tabs_on.gif" class="Font8vB" >&nbsp;&nbsp;&nbsp;&nbsp;IPD</td> 
               		...
               		<td colspan="2" 
                    	style="BORDER-LEFT: #c3d5ff 1PX SOLID;BORDER-BOTTOM: #c3d5ff 1PX SOLID;BORDER-RIGHT: #c3d5ff 1PX SOLID;" colspan="6">     
                       	<table border="0" align="center" cellpadding="2" cellspacing="3">
                            <tr>
                              <td class="grdback">MR No. : <font class="Font8vRed">*</font></td>
                              <td colspan="2">
							  ...
							  <td class="Font8vB">
							  Date :&nbsp;
							  <input class="mandtxtbox" type="text" name="createddate" id="createddate" value="<%=createddate%>" onfocus="blur();" size="12">
							  </td>
							  <td>&nbsp;</td>							  
                            </tr>
                            <tr>
                              <td class="grdback">Visit No. : <font class="Font8vRed">*</font></td>
                              <td colspan="2">
							  	<input class="mandtxtbox" type="text" name="regnno" id="regnno" maxlength="12" value="<%=regnno%>" size="12" onKeyUp="javascript:if(window.event.keyCode==13){document.frmOPD.stafffree.focus();}"/>
							  </td>
							  <td>&nbsp;</td>
